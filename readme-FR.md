...
L'objet principal de ce mod est d'ajouter un combat dynamique et plus relevé dans le repaire de Firkraag.

J'aime Baldur's Gate, et j'ai écrit ce mod (première version en 2010) pour comprendre un minimum les arcanes du modding. Grâce à Freddy_Gwendo, ce mod est désormais compatible avec les versions améliorées (BG2:EE et EET) et BGT. Je lui ai aussi récemment apporté certaines améliorations et des ajustements.
...
- Améliorer le charisme de certains boss (Tazok, DigDag, Sarevo).
...
><span style="margin-left: 50px;"><a href="#10">[10] Combat contre Tazok et DigDag révisé par DrAzTiK</a> <em>&nbsp;[à installer avant Stratagems]</em></span><br>
><span style="margin-left: 50px;"><a href="#11">[11] Rééquilibrage de certaines creatures génériques</a> <em>&nbsp;[à installer avant Stratagems]</em></span><br>
><span style="margin-left: 50px;"><a href="#12">[12] Rééquilibrage de Tazok et de DigDag</a> <em>&nbsp;[à installer avant Stratagems]</em></span><br>

><span style="margin-left: 50px;"><a href="#20">[20] Rencontre avec Groumf et Bourrinos devant le Donjon de Firkraag</a> <em>&nbsp;[à installer avant Stratagems]</em></span><br>
><span style="margin-left: 50px;"><a href="#21">[21] Rencontre avec Groumf et Bourrinos à Brynnlaw</a> <em>&nbsp;[à installer avant Stratagems]</em></span><br>
><span style="margin-left: 50px;"><a href="#22">[22] Rencontre avec Groumf et Bourrinos dans les Tréfonds Obscurs</a> <em>&nbsp;[à installer avant Stratagems]</em></span><br>

><span style="margin-left: 50px;"><a href="#30">{30] Combat revisité de Sarevok nécrophage dans les Abysses</a> <em>&nbsp;[à installer avant Stratagems]</em></span><br>
><span style="margin-left: 50px;"><a href="#31">{31] Relocalisation du groupe de Samia à l'entrée du donjon de Firkraag (BETA et buggé)</a> <em>&nbsp;[à installer avant ou après Stratagems]</em></span><br>
><span style="margin-left: 50px;"><a href="#32">{32] Musiques de combat dans les zones sans musique</a> <em>&nbsp;[à installer avant ou après Stratagems]</em></span><br>
...
><span style="margin-left: 50px;"><a href="#46">[46] Boucherie de trolls à l'extérieur du Château de'Arnise</a> <em>&nbsp;[à installer après Stratagems]</em></span><br>
...
><span style="margin-left: 50px;"><a href="#90">[90] Composant cosmétique</a> <em>&nbsp;[à installer avant ou après Stratagems]</em></span><br>


#### &#10173; Modification de la difficulté :

Il s'agit de l'amélioration la plus récente de ce mod. Je sais combien il peut être frustrant d'avoir un combat bien trop difficile, ou à l'inverse bien trop facile, et je voulais y apporter une solution. Le nombre et la variété des opposants seront ajustés en fonction du réglage du curseur de difficulté dans le menu Options du jeu. Les ajustements sont les suivants :

- <ins>Règles de base</ins> : nombre normal et décent d'ennemis (pas de prêtres, ni de mages).
- <ins>Difficile</ins> : plus d'ennemis et apparitions de quelques prêtres et mages.
- <ins>Très difficile</ins> : encore un peu plus d'ennemis et un peu plus de prêtres ou de mages.

Je vous préviens que le challenge sera sûrement déjà correct en mode « Règles de base », car je pars du principe que ce mod s'adresse à des personnes aimant la difficulté et maîtrisant un minimum le système de combat. :wink:

<div align="right"><a href="#top">Back to top</a></div>

------------------------

<a name="10" id="10"></a>&#10173; **[10] Combat contre Tazok et DigDag révisé par DrAzTiK**
###### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em>à installer avant Stratagems</em><br><br>

Il s'agit du tout premier composant, à la genèse de ce mod.
...
&#9755; Pour toute question ou demande d'assistance, veuillez consulter le <a href="https://www.baldursgateworld.fr/lacouronne/butchery/">forum du mod</a>.
...
###### Tout le contenu du mod appartient à &copy;DrAzTiK.
